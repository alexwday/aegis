...
from aegis.etls.call_summary_editor.main import _save_to_database
...
class TestSaveToDatabase:
    ...
    async def test_successful_save(
        ...
        with patch(
            "aegis.etls.call_summary_editor.main.get_connection", return_value=mock_cm
        ):
    ...
    async def test_insert_params_correct(
        ...
        assert params["generated_by"] == "call_summary_editor_etl"
