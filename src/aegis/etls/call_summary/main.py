...
Usage:
    ...
    python -m aegis.etls.call_summary.main benchmark \\
...
from aegis.etls.call_summary.transcript_utils import VALID_SECTION_KEYS
...
from aegis.etls.call_summary.interactive_pipeline import (
...
from aegis.etls.call_summary.nas_source import (
    extract_raw_blocks,
    find_transcript_xml,
    get_nas_connection,
    parse_transcript_xml,
)
from aegis.etls.call_summary.benchmark import (
    benchmark_recall,
    load_expected_items,
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Generate Call Summary DOCX and editor HTML reports",
