        ...
        "scores": {
            ...
            "items": {
                ...
                "properties": {
                    ...
                    "score": {
                        "type": "number",
                        "description": "Bucket relevance score from 0 to 10",
                    },
                },
...
_CATEGORY_DESCRIPTION_SECTION_RE = re.compile(
    r"^(?P<header>[A-Za-z][A-Za-z _/-]*):\s*(?P<rest>.*)$"
)
    ...
    for raw_line in raw.splitlines():
        ...
        if header_match:
            ...
            _append_unique_items(
                ...
                _split_category_description_items(
                    section or current_section_key,
                    header_match.group("rest"),
                ),
            )
            continue
...
def merge_sectioned_category_descriptions(
    ...
    for source in (existing, proposed):
        for section in source.get("additional_sections", []) or []:
            ...
            _append_unique_items(
                additional_sections[section_key]["items"],
                section.get("items", []),
            )
...
async def group_md_block_findings(
    *,
    ...
    prior_block = (
        prior_context or "[This is the first speaker block in the section — no prior context.]"
    )
    user_prompt = (
        "## Task\n"
